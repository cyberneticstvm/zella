...
class PDFController extends Controller
{
    ...
    public function salesinvoice($id){
        ...
        $sales = DB::table('sales_details as s')->leftJoin('products as p', 'p.id', '=', 's.product')->select('s.qty', 's.price', 's.total', 's.vat_percentage', 's.old_product', 's.return_date', 'p.name', 'p.vat_applicable')->where('s.sales_id', $id)->get();      
