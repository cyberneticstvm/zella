...
class UserController extends Controller
{
    ...
    function __construct(){
        ...
        $this->sales_last_year = DB::table('sales')->where('is_dead_stock', 0)->count('id');
        ...
        $this->expense_last_year = DB::table('expenses')->sum('amount');
