                        ...
                        <form method="post" action="{{ route('user.create') }}">
                            ...
                            <div class="row g-3">
                                <div class="col-sm-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Full Name" value="{{ old('name') }}" required="required" name="name">
                                    @error('name')
                                ...
                                <div class="col-sm-3">
                                    <label for="TextInput" class="form-label">Password <span class="req">*</span></label>
                                    <input type="password" class="form-control" placeholder="Password" required="password" name="password" value="{{ old('password') }}">
                                    @error('password')
