        ...
        <div class="container">
            <div class="d-flex flex-wrap align-items-center justify-content-between">
                <a href="#" class="logo d-flex align-items-center me-md-4 me-2">
                    ...
                    <span class="fs-4 fw-bold ms-2">ZELLA</span>
                </a>
                <div class="d-flex">
        ...
        <div class="container">
            <ul class="menu-list">
                ...
                <li class="collapsed">
                    ...
                    <!-- Menu: Sub menu ul -->
                    <ul class="sub-menu collapse show" id="menu-Pages">
                        <li><a class="ms-link" href="/user/">User Register</a></li>
                    </ul>
                </li>
                <li class="collapsed">
                    <a class="m-link" data-bs-toggle="collapse" data-bs-target="#menu-Pages" href="#"><i class="fa fa-gift"></i> <span>Product</span> <span class="arrow fa fa-plus ms-auto text-end"></span></a>
                    <!-- Menu: Sub menu ul -->
                    <ul class="sub-menu collapse show" id="menu-Pages">
                        <li><a class="ms-link" href="/">Product Register</a></li>
                        <li><a class="ms-link" href="/">Collection Register</a></li>
                    </ul>
                </li>
                <li class="collapsed">
                    <a class="m-link" data-bs-toggle="collapse" data-bs-target="#menu-Pages" href="#"><i class="fa fa-cubes"></i> <span>Stock</span> <span class="arrow fa fa-plus ms-auto text-end"></span></a>
                    <!-- Menu: Sub menu ul -->
                    <ul class="sub-menu collapse show" id="menu-Pages">
                        <li><a class="ms-link" href="/">Purchase Register</a></li>
                        <li><a class="ms-link" href="/">Sales Register</a></li>
                        <li><a class="ms-link" href="/">Purchase Return Register</a></li>
                        <li><a class="ms-link" href="/">Sales Return Register</a></li>
                    </ul>
                </li>
                <li class="collapsed">
                    <a class="m-link" data-bs-toggle="collapse" data-bs-target="#menu-Pages" href="#"><i class="fa fa-file-o"></i> <span>Daybook</span> <span class="arrow fa fa-plus ms-auto text-end"></span></a>
                    <!-- Menu: Sub menu ul -->
                    <ul class="sub-menu collapse show" id="menu-Pages">
                        <li><a class="ms-link" href="/">Expense Register</a></li>
                        <li><a class="ms-link" href="/">Income Register</a></li>
                    </ul>
                </li>
                <li class="collapsed">
                    <a class="m-link" data-bs-toggle="collapse" data-bs-target="#menu-Pages" href="#"><i class="fa fa-bar-chart"></i> <span>Reports</span> <span class="arrow fa fa-plus ms-auto text-end"></span></a>
                    <!-- Menu: Sub menu ul -->
                    <ul class="sub-menu collapse show" id="menu-Pages">
                        <li><a class="ms-link" href="/">Purchase</a></li>
                        <li><a class="ms-link" href="/">Purchase Return</a></li>
                        <li><a class="ms-link" href="/">Sales</a></li>
                        <li><a class="ms-link" href="/">Sales Return</a></li>
                        <li><a class="ms-link" href="/">Expense</a></li>
                    </ul>
                </li>
                <li class="collapsed">
                    <a class="m-link" data-bs-toggle="collapse" data-bs-target="#menu-Pages" href="#"><i class="fa fa-line-chart"></i> <span>Analytics</span> <span class="arrow fa fa-plus ms-auto text-end"></span></a>
                    <!-- Menu: Sub menu ul 
                    <ul class="sub-menu collapse show" id="menu-Pages">
                        <li><a class="ms-link" href="/">Purchase</a></li>
                    </ul>-->
                ...
                <li class="collapsed">
                    <a class="m-link" data-bs-toggle="collapse" data-bs-target="#menu-Pages" href="#"><i class="fa fa-gear"></i> <span>Settings</span> <span class="arrow fa fa-plus ms-auto text-end"></span></a>
                    <!-- Menu: Sub menu ul -->
                    <ul class="sub-menu collapse show" id="menu-Pages">
                        <li><a class="ms-link" href="/">Value Added Tax</a></li>
                    </ul>
                </li>
            </ul>
        </div>
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        <div class="row justify-content-between align-items-center">
                            <div class="col">
                                <p class="font-size-sm mb-0">© ZELLA. <span class="d-none d-sm-inline-block"><script>document.write(/\d{4}/.exec(Date())[0])</script> <a href="https://zellaboutiqueuae.com" target="_blank">zellaboutiqueuae.com</a></span></p>
                            </div>
                            <div class="col-auto">
                                <ul class="list-inline d-flex justify-content-end mb-0">
                                    <li class="list-inline-item">Developed by <a class="list-separator-link" href="https://cybernetics.me" target="_blank">Cybernetics</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
