...
<div class="body-header d-flex py-3">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-auto">
                <h1 class="fs-4 mt-1 mb-0">Create Collection</h1>
            ...
            <div class="col-12">
                ...
                <div class="card mb-2">
                    <div class="card-body p-4">
                        <form method="post" action="{{ route('collection.create') }}">
                            @csrf
                            <div class="row g-3">
                                <div class="col-sm-4">
                                    <label for="TextInput" class="form-label">Collection Name <span class="req">*</span></label>
                                    <input type="text" class="form-control" placeholder="Collection Name" value="{{ old('name') }}" required="required" name="name">
                                    @error('name')
