...
<div class="body-header d-flex py-3">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-auto">
                <h1 class="fs-4 mt-1 mb-0">Update Expense</h1>
                            ...
                            <div class="row g-3">       
                                <div class="col-sm-3">
                                    ...
                                    <fieldset class="form-icon-group left-icon position-relative">
                                        <input type="text" name="expense_date" class="form-control form-control-md dtpicker" value="{{ date('d/M/Y', strtotime($expense->expense_date)) }}" placeholder="dd/mm/yyyy" required="required">
                                ...
                                <div class="col-sm-2">
                                    ...
                                    <input type="number" class="form-control" placeholder="0.00" name="amount" value="{{ $expense->amount }}" required="required">
                                    @error('amount')
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <input type="text" value="{{ $expense->description }}" class="form-control form-control-md" name="description" placeholder="Description" required="required" />
                                    @error('description')
