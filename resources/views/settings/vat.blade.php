            ...
            <div class="col-12">
                ...
                <div class="card mb-2">
                    <div class="card-body p-4">
                        <form method="post" action="{{ route('vat.update', $settings->id) }}">
                            @csrf
                            <div class="row g-3">
                                <div class="col-sm-2">
                                    <label for="TextInput" class="form-label">VAT % <span class="req">*</span></label>
                                    <input type="text" class="form-control" value="{{ $settings->vat_percentage }}" name="vat_percentage">
