...
<div class="body-header d-flex py-3">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-auto">
                <h1 class="fs-4 mt-1 mb-0">Stock Out Report</h1>
            ...
            <div class="col-12">
                ...
                <div class="card mb-2">
                    <div class="card-body p-4">
                        <form method="post" action="{{ route('reports.stockout') }}">
                            @csrf
                            <div class="row g-3">
                            <div class="col-sm-3">
                        ...
                        <div class="mt-5">
                            <table id="dataTbl" class="table table-sm display dataTable table-hover table-striped"><thead><tr><th>SL No.</th><th>Invoice</th><th>Customer</th><th>Product</th><th>Date</th><th>Payment Mode</th><th>Qty</th><th>Price</th><th>Total</th></tr></thead><tbody>
                            @php $c = 1; @endphp
